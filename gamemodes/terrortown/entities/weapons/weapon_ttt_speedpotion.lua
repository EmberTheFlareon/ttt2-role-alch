...
if CLIENT then
   ...
   SWEP.Instructions       = "Throw to zoom"
   SWEP.Slot               = 8
...
SWEP.ViewModel             = Model("models/sohald_spike/props/potion_4.mdl")
SWEP.WorldModel            = Model("models/sohald_spike/props/potion_4.mdl")
SWEP.Weight                = 5
