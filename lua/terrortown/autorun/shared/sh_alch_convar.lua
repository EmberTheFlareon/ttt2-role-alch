...
CreateConVar("ttt2_alch_jump_potion_time", "15", {FCVAR_ARCHIVE, FCVAR_NOTIFY})
CreateConVar("ttt2_alch_jump_potion_jump", "220", {FCVAR_ARCHIVE, FCVAR_NOTIFY})
...
CreateConVar("ttt2_alch_armor_potion_amnt", "5", {FCVAR_ARCHIVE, FCVAR_NOTIFY})
...
hook.Add("TTTUlxDynamicRCVars", "TTTUlxDynamicAlchemistCVars", function(tbl)
  ...
  table.insert(tbl[ROLE_ALCHEMIST], {
    cvar = "ttt2_alch_jumo_potion_jump",
    slider = true,
    min = 200,
    max = 400,
    desc = "Jump Potion Height (def. 220)"
  })
  ...
  table.insert(tbl[ROLE_ALCHEMIST], {
    ...
    min = 5,
    max = 60,
    desc = "Armor Potion Amount (def. 15)"
  })
